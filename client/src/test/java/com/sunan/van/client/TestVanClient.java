...
public class TestVanClient {
	...
	public TestVanClient(String host, int port) {
		this.host = host;
		this.port = port;
	}
...
//		}
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 2) {
			System.err.println("Usage: " + TestVanClient.class.getSimpleName()
					+ " <host> <port>");
			// return;
		} else {
		...
		new TestVanClient(host, port).run();
	}
}
